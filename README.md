...
> 一个可离线使用的古诗词学习应用：支持查诗、阅读注释、背诵训练、收藏分组、学习统计与 AI 辅助理解。  
> 适用于学生背诵、教师备课、古诗词爱好者日常学习。
> 下载地址：https://pan.quark.cn/s/07c9019b355d
## 📖 项目简介
...
- **AI 辅助学习**：围绕当前诗词生成补充注释、赏析解读、理解提示、背诵建议和复习思路

---

## 🤖 AI 赋能说明

AI 功能作为基础诗词学习能力的增强层存在，不替代原有离线数据，也不改写本地诗词原文、注释、译文和赏析内容。其主要作用是根据当前诗词上下文，为学习者提供更易理解、更贴近背诵场景的辅助信息。

当前 AI 赋能主要覆盖：

- **AI 注释补充**：对生僻词、典故、意象和关键句进行补充解释
- **AI 赏析辅助**：从主题情感、表现手法、结构层次和语言特点等角度生成理解提示
- **背诵建议**：根据诗词篇幅、句式和意象线索给出分段记忆、关键词记忆、意象串联等建议
- **辅助背诵**：围绕当前诗词生成提问、提示和复习路径，帮助用户从“读懂”过渡到“背熟”
- **学习反馈**：结合收藏、掌握状态、复习次数等本地学习记录，为后续复习提供参考

说明：基础检索、阅读、收藏、分组和背诵功能仍可离线使用；AI 相关能力通常需要网络环境和可用的大模型服务配置。AI 生成内容仅作为学习辅助，具体释义和赏析仍建议结合原始资料、教材和教师讲解进行判断。
...
AI 相关功能需要可用的大模型服务配置。不同部署方式下的具体配置项可能不同，建议根据实际部署环境配置服务地址、模型名称和访问密钥，并避免将密钥提交到仓库。
...
### Q6：AI 功能是否会影响离线使用？
不会。基础诗词数据、检索、阅读、收藏、分组和背诵训练仍以本地能力为主；AI 生成类功能在没有网络或模型服务不可用时可能无法使用。
